...
ClientToGREMessage.  Derived from decompiled protobuf models:
  - re-output/GreProtobuf/.../PerformActionResp.cs
  - re-output/GreProtobuf/.../Action.cs
  - re-output/GreProtobuf/.../ClientToGREMessage.cs
  - re-output/GreProtobuf/.../ActionType.cs
  - re-output/GreProtobuf/.../TargetSelection.cs
  - re-output/GreProtobuf/.../Target.cs
...
# ---------------------------------------------------------------------------
# Protobuf enum mirrors (from decompiled ActionType.cs, AutoPassPriority.cs,
